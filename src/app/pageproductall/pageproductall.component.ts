...
@Component({
  selector: 'app-pageproductall',
  templateUrl: './pageproductall.component.html',
  styleUrls: ['./pageproductall.component.scss']
})
export class PageproductallComponent implements OnInit {
  name: string = '';
